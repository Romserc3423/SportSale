...
$sqlNombre = "SELECT usuario FROM asesores WHERE idasesores = ?";
    ...
    <div class="manager-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    <li><a href="#" id="nav-dashboard" class="active"><i class="fas fa-tachometer-alt"></i> Resumen</a></li>
        ...
        <main class="content-area">
            <header class="content-header">
               <h1>Bienvenido, <?php echo htmlspecialchars($nombreAsesor); ?>!</h1>
            </header>
